...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        while (true) {
            ...
            System.out.println("2. Lihat info Ternak");
            System.out.println("3. Lihat info lengkap");
            System.out.println("4. Update Ternak");
            System.out.println("5. Hapus Ternak");
    ...
    private static void lihatTernak() throws IOException {
        lihatTernak(false);
    }
    
    private static void lihatTernak(boolean detail) throws IOException {
        for (Lokasi lokasi : daftarLokasi) {
            lokasi.displayTernakDanInfo(detail);
        }
    }
